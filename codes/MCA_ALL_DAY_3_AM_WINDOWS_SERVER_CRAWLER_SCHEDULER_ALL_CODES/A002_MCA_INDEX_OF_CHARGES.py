    ...
    try:
        ...
        def captcha(cin):
            try:
                ...
                driver.find_element(By.XPATH,"//*[@id='chargeForm_0']").click()
            except:
                print('error 1')
        ...
        while (loop<=5):
            try:
                ...
                cin_list1=cin_list['Cin'][:120-count]
                cin_company=cin_list['Company_Name'][:120-count]
                ...
                for cin,company in zip(cin_list1,cin_company):
                    ...
                    while(limit<=10):
                        ...
                        try:
                            ...
                            if 'No Charges' in err_msg   :
                                print(err_msg)
                                connection.execute("Update AdqvestDB.MCA_INDEX_OF_CHARGES_WEEKLY_STATUS set Status='No Charges' where Cin='"+cin+"'")
                                raise ElementNotInteractableException
                            elif 'CIN/LLPIN/FLLPIN/FCRN' in err_msg:
                                print(err_msg)
                                connection.execute("Update AdqvestDB.MCA_INDEX_OF_CHARGES_WEEKLY_STATUS set Status='No CIN' where Cin='"+cin+"'")
                                print('STOPPED')
                                raise ElementNotInteractableException
                    ...
                    if True not in ismatch:
                        ...
                        company_name=driver.find_element(By.XPATH,'//*[@id="companyInfo"]/tbody/tr[2]/td[2]').text
                        soup=BeautifulSoup(driver.page_source)
                        # cin_new=driver.find_element_by_xpath('//*[@id="companyInfo"]/tbody/tr[1]/td[2]').text
                        cin_new=driver.find_element(By.XPATH,'//*[@id="companyInfo"]/tbody/tr[1]/td[2]').text
                    ...
                    while True:
                        if True not in ismatch:
                            ...
                            try:
                                ...
                                driver.find_element(By.XPATH,'//*[@class="next paginate_button"]').click()
                    ...
                    mca_df.insert(2,'Company_Name',company)
        #             mca_df.insert(1,'Cin_New',cin_new)
                    ...
                    for j in mca_df['Charge_Id'].unique():
                        if (len(mca_df[mca_df['Charge_Id']==j]) >1):
                            modify = mca_df[mca_df['Charge_Id']==j]
                            mca_df.drop(index = modify[:-1].index[0], inplace=True)

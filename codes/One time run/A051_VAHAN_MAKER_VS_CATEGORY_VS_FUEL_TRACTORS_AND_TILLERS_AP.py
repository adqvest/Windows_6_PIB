...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS'
    ...
    try:
        ...
        def clicking_tabular_summary(driver):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//div[@class = 'ui-selectonemenu-trigger ui-state-default ui-corner-right']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()
                    time.sleep(4)
                    no_of_ping += 1
                    driver.find_element("xpath","//li[@class='ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all'][@data-label='Tabular Summary']").click()
                    time.sleep(2)
                    break
                except:
                    limit = limit + 1
        ...
        def choose_y_axis(driver,y_axis):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//label[@id='yaxisVar_label']").click()
                    time.sleep(2)
                    driver.find_element("xpath","//li[@data-label = '"+y_axis+"']").click()
        ...
        def choose_x_axis(driver,x_axis):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//label[@id='xaxisVar_label']").click()
                    time.sleep(2)
                    driver.find_element("xpath","//*[starts-with(@id, 'xaxisVar')]/li[@data-label = '"+x_axis+"']").click()
        ...
        def click_submit(driver):
            ...
            while True:
                try:
                    no_of_ping += 1
                    #driver.find_element("xpath","//*[@class = 'button-section']/button[@type = 'submit']").click()
                    element = driver.find_element("xpath","//*[@class = 'button-section']/button[@type = 'submit']")
        ...
        def click_year(driver,year):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//div[@id = 'selectedYear']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()

                    time.sleep(1)
                    # driver.find_element("xpath","//li[@data-label = '"+year+"']").click()
                    driver.find_element("xpath","//*[@id = 'selectedYear_items']/li[@data-label = '"+year+"']").click()
                    break
                except:
                    limit = limit + 1
                    print('error')
        ...
        def click_month(driver,month):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//div[@id = 'groupingTable:selectMonth']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()

                    time.sleep(1)
                    driver.find_element("xpath","//li[@data-label = '"+month+"']").click()
                    break
                except:
                    limit = limit + 1
                    print('error')
        ...
        def download_file(driver):
            ...
            while True:
                try:
                    no_of_ping += 1
                    driver.find_element("xpath","//a[@id = 'groupingTable:xls']").click()
                    break
                except:
                    limit = limit + 1
                    print('error')
        ...
        def fill_state(driver, st, state_info):
            ...
            while True:
                try:
                    ...
                    try:
                        try:
                            driver.find_element("xpath","//div[@id='j_idt31']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()
                        except:
                            driver.find_element("xpath","//div[@id='j_idt32']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()
                    except:
                        driver.find_element("xpath","//div[@id='j_idt43']//div[@class = 'ui-selectonemenu-trigger ui-state-default ui-corner-right']").click()

                    time.sleep(2)
                    no_of_ping += 1
                    driver.find_element("xpath","//li[@class='ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all'][text()='" + state_info[st] + "']").click()
                    # driver.find_element("xpath","//li[@data-label = '"+state_info[st]+"']").click()
        ...
        def fill_rto(driver, rto, rto_info):
            ...
            while True:
                try:
                    print('in rto')
                    no_of_ping += 1
                    driver.find_element("xpath","//div[@id='selectedRto']//span[@class='ui-icon ui-icon-triangle-1-s ui-c']").click()
                    time.sleep(1)
                    no_of_ping += 1
        #             driver.find_element("xpath","//li[@class='ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all'][text()='" + rto_info[rto] + "']").click()
                    driver.find_element("xpath","//li[@data-label = '"+rto_info[rto]+"']").click()
                    time.sleep(1)
                    break
                except:
                    limit = limit + 1
        ...
        def get_fuels(driver):
            ...
            while True:
                try:
                    try:
                        driver.find_element("xpath","//*[@id='filterLayout']/div[1]/a/span").click()
                    except:
                        pass
                    driver.find_element("xpath",'//*[@id="filterLayout-toggler"]/span/a').click()
                    time.sleep(0.5)
                    #no_of_ping += 1
                    fuel_info = {}
                    soup = BeautifulSoup(driver.page_source, 'lxml')
        ...
        def get_dates(cond):
            query = "select distinct Relevant_Date FROM VAHAN_MAKER_VS_CATEGORY_VS_FUEL_CLEAN_TABLE where Relevant_Date>='2014-01-31' and Relevant_Date <='2022-12-31'"
        ...
        def data_check():
            ...
            data_df = pd.read_sql("Select  Sum(Total) as RTO ,RTO_Office_Raw,State,RTO_Code,Relevant_Date from AdqvestDB.VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP  group by RTO_Office_Raw,Relevant_Date",engine)
            ...
            if(error_df.empty):
                ...
                for index,i in error_df.iterrows():
                    connection.execute("update VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP set RTO_Status = Null,State_Status = Null where RTO_Office_Raw = '" +i["RTO_Office_Raw"]+"'")
                    connection.execute("commit")

                    connection.execute("update VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP set State_Status = Null where State = '" +i["State"] +"'")
                    connection.execute("commit")


                    connection.execute("delete from VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP where RTO_Code = '" +i["RTO_Code"]+"' and Relevant_Date >= '"+error_df["Relevant_Date"].min().strftime("%Y-%m-%d")+"' and Relevant_Date <= '"+error_df["Relevant_Date"].max().strftime("%Y-%m-%d")+"'")
                    connection.execute("commit")
        ...
        def main_function():
            ...
            while True:
                try:
                    ...
                    download_file_path = r"C:\Users\Administrator\Junk_Vahan_3_AP2"

                    os.chdir(r"C:\Users\Administrator\Junk_Vahan_3_AP2")
                    ...
                    maker_df = pd.read_sql("select * from VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP", con=engine)
                    if(maker_df.empty):
                        maker_done.to_sql("VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP", con=engine, index=False, if_exists='append')

                    #########################################
                    query = "select min(Relevant_Date) as Min FROM VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP"
                    ...
                    for st in state_info:
                        ...
                        for i in range(len(dates_df)):
                            ...
                            for vc in vehicle_class_info.items():
                                ...
                                driver.find_element("xpath","//*[@id='VhClass']/tbody/tr["+str(vc[1])+"]/td/label").click()
                            for jk in fuel_info.items():
                                print(jk)
                                driver.find_element("xpath","//*[@id='fuel']/tbody/tr["+str(jk[1])+"]/td/label").click()

                                # driver.find_element_by_xpath("//*[@id='j_idt66']/span[2]").click()
                                driver.find_element("xpath","//*[@id='j_idt67']/span[2]").click()
                                time.sleep(1)
                            ...
                            for jk in other_fuels:
                                driver.find_element("xpath","//*[@id='fuel']/tbody/tr["+str(jk)+"]/td/label").click()
                        ...
                        vahan_maker_cat_fuel_rto_level.to_sql(name = "VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP", con=engine, index=False, if_exists='append')
                        ...
                        connection.execute("update VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP set State_Status = 'Done' where State = '"+state+"'")
                        connection.execute("commit")
                ...
                try:
                    ...
                    pass
            data_check()
            query = "delete from VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP"
            connection.execute(query)
            connection.execute('commit')

            #maker vs category
            date_vahan = pd.read_sql("select min(Relevant_Date) as Date from VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP", con=engine)
            ...
            # query = "delete from VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_AP where Relevant_Date>='" + date_vahan + "'"
            # connection.execute(query)
            # connection.execute('commit')

            try:
                df = pd.read_sql("select * from VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP", con=engine)
                df.to_sql(name='VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_AP', con=engine, index=False, if_exists='append')

            except:
                print('ERROR 3')
                raise Exception('error in VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP')


            query = "drop table VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP"
            connection.execute(query)
            connection.execute('commit')
            ...
            # vahan_table_list = ["VAHAN_MAKER_VS_CATEGORY_VS_FUEL_RTO_LEVEL_DATA"]
        ...
        def table_check():
            query = "SELECT * FROM information_schema.tables WHERE table_schema = 'AdqvestDB' AND TABLE_NAME in ('VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP')"
        ...
        query = "SELECT * FROM VAHAN_TABULAR_SUMMARY_WITH_FUEL_FOR_TRACTORS_STATE_DONE_AP"
        ...
        if(( vahan_maker_state_done.shape[0]>0 ) | (table_check())):
            ...
            if(today.day in [4,9,10,19,22,28]):

                print('B')

                query = "create table AdqvestDB.VAHAN_MAKER_VS_CATEGORY_VS_FUEL_TRACTORS_AND_TILLERS_Temp_AP select * from AdqvestDB.VAHAN_MAKER_VS_CATEGORY_VS_FUEL_RTO_LEVEL_DATA limit 0"
                connection.execute(query)
                connection.execute('commit')

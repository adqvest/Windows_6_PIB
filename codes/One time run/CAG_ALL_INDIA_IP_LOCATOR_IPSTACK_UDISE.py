# -*- coding: utf-8 -*-
"""
Created on Mon May  3 11:30:25 2021
...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'CAG_PAN_INDIA_IP_ADDRESS_LOCATOR_IPSTACK_UDISE'
    ...
    try:
        ...
        for i,row in value.iterrows():
            ...
            try:
                ...
                a.to_sql(name="CAG_PAN_INDIA_IP_ADDRESS_LOCATOR_IPSTACK_UDISE",con=engine,if_exists='append',index=False)

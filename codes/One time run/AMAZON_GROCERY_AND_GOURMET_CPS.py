...
table_name = 'AMAZON_GROCERY_AND_GOURMET_CPS'
...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        max_date,cols = client.execute("Select max(Relevant_Date) as RD from AdqvestDB.AMAZON_GROCERY_AND_GOURMET_FOODS_CLEAN",with_column_types=True)
        ...
        query = """Select Category,Sub_Category_1,Sub_Category_2,Sub_Category_3,Sub_Category_4
                  from AdqvestDB.AMAZON_GROCERY_AND_GOURMET_FOODS_CLEAN where Category = 'Grocery & Gourmet Foods'
        ...
        for k,row in df_catg.head(100).iterrows():
        ...
        #    catg_df = pd.concat([catg_df,a])
            ...
            query3 = "Select * from AdqvestDB.AMAZON_GROCERY_AND_GOURMET_FOODS_CLEAN where Category = '"+category+"' and Sub_Category_1 = '"+sub_category1+"' and  Sub_Category_2 = '"+sub_category2+"' and Sub_Category_3 = '"+sub_category3+"' and Sub_Category_4 = '"+sub_category4+"' and Relevant_Date >= '"+str(start)+"' and Relevant_Date <= '"+str(finish)+"';"
            ...
            main1 = main1[['Pdt', 'Brand', 'Category', 'Sub_Category_1', 'Sub_Category_2','Sub_Category_3', 'Sub_Category_4','Value','Relevant_Month','Relevant_Date']]
           # main1.to_sql(name='AMAZON_BEAUTY_CPS_SCORES',con=engine1,if_exists='append',index=False,chunksize=2000)
            print(main1.groupby(['Relevant_Month'])['Value'].sum())
            client.execute("INSERT INTO AdqvestDB.AMAZON_GROCERY_AND_GOURMET_CPS_SCORES VALUES", main1.values.tolist())
            del r
            del df
            del main1

...
#%%
        ...
        done = pd.read_sql("Select Distinct Page from AdqvestDB.MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_NO_PIT_NF",con=engine)
        done_cols = pd.read_sql("Select * from AdqvestDB.MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_NO_PIT_NF limit 1",con=engine)
        headers = {"user-agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"}

...
#        export_top_500 = export_top_500[export_top_500['HSCode']=='2710']       
#%%
...
#            max_rel_date=pd.read_sql("select max(Relevant_Date) as MAX from AdqvestDB.EXPORTS_DATA_COUNTRY_WISE_MONTHLY where HSCode="+export_top_500['HSCode'].iloc[code],engine)['MAX'][0]
            max_rel_date = export_top_500['Relevant_Date'].iloc[code]
            date1 = max_rel_date
...
#                          df_final = df_final[df_final['Monthly_Value_INR_In_Lakhs_Current_Year'].notna()]                           

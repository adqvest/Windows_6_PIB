    ...
    try:
        ...
        def get_dates(cond):
            ...
            if(cond):
                ...
                dates_df = dates_df[:2] #change this later
        ...
        def rto_count():
            ...
            while True:
                try:
                    ...
                    for st in state_info:
                        ...
                        ss = [re.search(st + r'[0-9]+',x)[0] for x in ss]
                        rto_df = pd.DataFrame({"RTO":ss})
                        rto_df["Relevant_Date"] = today.date()
                        rto_df['Runtime'] = pd.to_datetime(today.strftime("%Y-%m-%d %H:%M:%S"))
                        rto_full_df = pd.concat([rto_full_df,rto_df])
            ...
            rto_full_df.to_sql(name = "VAHAN_TABULAR_SUMMARY_RTOS",con = engine,index = False,if_exists = 'append')
        ...
        def get_overall_data():
            ...
            while True:
                try:
                    ...
                    chrome_driver_path = r"C:\Users\Administrator\AdQvestDir\chromedriver.exe"
                    #download_file_path = r"D:\advaith\Adqvest\Junk"
                    download_file_path = r"C:\Users\Administrator\Junk_Vahan_2"

                    os.chdir(r"C:\Users\Administrator\Junk_Vahan_2")
                    ...
                    #########################################
                    start_date = today.date() - relativedelta(months=+16)

...
#    os.chdir(r'C:\Adqvest')
    ...
    try :
                ...
                try:
                 ...
                 #  import yaml
                    for i in range(len(df2)):
                        if re.findall("Proposal Accepted by MS on",df2[i]):
                            df2[i]="Proposal Accepted by MS"
                        if re.findall("Date of EC granted",df2[i]):
                            df2[i]="Date of EC Granted"
        ...
        query = "Select max(Relevant_Date) as RD from AdqvestDB.MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_FINAL_PIT_NEW_CLEAN_DATA"
    ...
    #        output.columns = [x.replace("Moefcc")]
            ...
            print(output)
            output.columns=['SNo', 'Proposal_No', 'Moefcc_File_No', 'Project_Name', 'Company',
                   'Proposal_Status', 'Level_2_Functions', 'Page', 'Relevant_Date',
                   'Runtime', 'Proposal No', 'File No', 'Proposal Name', 'State',
                   'District', 'Tehsil', 'Date_of_Submission_for_TOR',
                   'Date_of_TOR Granted', 'Date_of_Submission_for_EC',
                   'Proposal_Accepted_by_MS', 'Date_of_EC_Granted', 'Function',
                   'Timestamp', 'Date_of_Submission', 'Date_of_Deletion',
                   'Date_of_previous_TOR_Granted']
            try:
        ...
        #        output.columns = [x.replace("Moefcc")]
            ...
            #            output = output[list(done_cols.columns)]
                ...
                print("Only one page in the website")
            '''
            ...
            print(df.columns)
            df.columns=['SNo', 'Proposal_No', 'Moefcc_File_No', 'Project_Name', 'Company',
                               'Proposal_Status', 'Level_2_Functions', 'Page', 'Relevant_Date',
                               'Runtime', 'Proposal No', 'File No', 'Proposal Name', 'State',
                               'District', 'Tehsil', 'Date_of_Submission_for_TOR',
                               'Date_of_TOR Granted', 'Date_of_Submission_for_EC',
            ...
            df['Proposal_Accepted_by_MS']=df['Proposal_Accepted_by_MS'].apply(lambda x:get_date(x))
            ...
            final = final[[x for x in final.columns if x!= 'Timestamp']]
            final=final[['SNo','State', 'District', 'Tehsil','Project_Name', 'Company','Proposal Name','Proposal_No','Proposal_Status','Moefcc_File_No','Date_of_Submission_for_TOR',
                       'Date_of_TOR Granted', 'Date_of_Submission_for_EC',
                       'Proposal_Accepted_by_MS', 'Date_of_EC_Granted', 'Date_of_Submission',
                       'Date_of_Deletion', 'Date_of_previous_TOR_Granted','Relevant_Date', 'Runtime']]
            final.columns=['SNo','State', 'District', 'Tehsil','Project_Name', 'Company','Proposal_Name','Proposal_No','Proposal_Status','Moefcc_File_No','Date_of_Submission_for_TOR',
                       'Date_of_TOR Granted', 'Date_of_Submission_for_EC',
                       'Proposal_Accepted_by_MS', 'Date_of_EC_Granted', 'Date_of_Submission',
                       'Date_of_Deletion', 'Date_of_previous_TOR_Granted','Relevant_Date', 'Runtime']


            final.to_sql(name = "MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_FINAL_PIT_NEW_CLEAN_DATA",con = engine,if_exists = 'append',index = False)
            ...
            try:
                ...
                pass
                # cd1.to_sql(name = "MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_FINAL_PIT_CLEAN_DATA",con = engine,if_exists = 'append',index = False)
        else:

...
#%%     
        ...
        for company in execution_list:
            ...
            status_empty_data=pd.read_sql(f"select * from AMC_COMPANY_WISE_ABRIDGED_ANNUAL_REPORT_LINKS where S3_Update_Status is null and Company_Name='{company}'", con=engine)

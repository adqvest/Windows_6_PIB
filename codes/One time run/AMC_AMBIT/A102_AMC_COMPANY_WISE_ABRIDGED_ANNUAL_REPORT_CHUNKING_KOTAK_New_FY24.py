...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        req_quarter=['FY22']
        execution_list = ["Bandhan Mutual Fund"]
        # req_file_id=[]
                            ...
                            if len(text)>0:
                                for i, chunk in enumerate(text):
                                    ...
                                    # try:
                                        if len(table)>1:
                                            try:
                                                table_content_str = [item for sublist in table[1] for item in sublist]
                                                ...
                                                table_embed = str(create_embeddings(table_content_str)).replace('[[','[').replace(']]',']')
                                                table_embed_small = str(create_embeddings(table_content_str.lower())).replace('[[','[').replace(']]',']')

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):    
    ...
    try:
        ...
        # query = "SELECT * FROM CRISIL_DAILY_DATA_CORPUS_NEW where File_ID > 50000 AND File_ID < 70000 AND Chunking_Status is Null;"
        crisil_ratings = pd.read_sql(query,con=engine)
        crisil_ratings = crisil_ratings[18000:24000].reset_index(drop=True)

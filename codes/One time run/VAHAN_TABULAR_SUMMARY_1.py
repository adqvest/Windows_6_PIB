    ...
    try:
        ...
        while True:
            try:
                ...
                download_file_path = r"C:\Users\Administrator\Junk_2"

                os.chdir(r"C:\Users\Administrator\Junk_2")
                ...
                # distinct_states = pd.read_sql("select distinct(State) from VAHAN_TABULAR_SUMMARY_STATE_DONE_Adv", con=engine)
                # state_list = np.array_split(distinct_states,2)[0]["State"].tolist()
                ...
                for st in state_info:
                    ...
                    for x in rto_info.keys():
                        ...
                        start_date = datetime.date(2020,7,31)
                        ...
                        dates_df = dates_df[:len(dates_df)-1]
                        ####################################################################
                        ...
                        vahan_maker_cat_rto_level.to_sql(name = "VAHAN_MAKER_VS_CATEGORY_RTO_LEVEL_DATA", con=engine, index=False, if_exists='append')
                        ...
                        vahan_fuel_maker_rto_level.to_sql(name = "VAHAN_MAKER_VS_FUEL_RTO_LEVEL_DATA", con=engine, index=False, if_exists='append')
                        ...
                        vahan_fuel_cat_rto_level.to_sql(name = "VAHAN_FUEL_VS_CATEGORY_RTO_LEVEL_DATA", con=engine, index=False, if_exists='append')

                        connection.execute("update VAHAN_TABULAR_SUMMARY_STATE_DONE_Adv set RTO_Status = 'Done',Run_By = '1' where State = '"+state+"' and RTO_Office_Raw = '" +rto+"'")

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try :
        ...
        def data_collection_au(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                try:
        ...
        #             df=df[df['Relevant_Date']>max_date]
                    ...
                    if loop <2:
                        ...
                        df=data_collection_au(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                    else:
                        print("Something went wrong either camelot or illovepdf worked check manually")
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        ...
                        if len(tables)>1:
                            df=data_collection_au(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            connection = engine.connect()
                        ...
                        df=data_collection_au('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)


        def data_collection_hdfc(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
        ...
        #         df=df[df['Relevant_Date']>max_date]
                ...
                if loop <2:
                    ...
                    e='Somethig went wrong with both ilove pdf and camelot'
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,True,'stream',10,200,70)
                        if len(tables)>1:
                            df=data_collection_hdfc(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                        ...
                        df=data_collection_hdfc('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

        def data_collection_sbi(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                try:
                    if type_read=='camelot':
                        df=get_desired_table(tables,search_str)
        ...
        #                 df=df[df['Relevant_Date']>max_date]
                    ...
                    if loop <2:
                        ...
                        end_text='total'
                        df=search(heading,end_text,path,sheets)
                        df=data_collection_sbi(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                    else:
                        e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            except Exception as e:
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,True,'stream',10,200,70)
                        if len(tables)>1:
                            df=data_collection_sbi(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_sbi('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)


        def data_collection_icici_axis_kotak(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
        ...
        #         df=df[df['Relevant_Date']>max_date]
                ...
                if loop <2:
                    ...
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_icici_axis_kotak(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        ...
                        if len(tables)>1:
                            df=data_collection_icici_axis_kotak(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_icici_axis_kotak('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)
        ...
        def data_collection_central_federal_baroda(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if loop <2:
                    ...
                    if bank=='CENTRAL BANK OF INDIA':
                        ...
                        end_text='total'
                        df=search(heading,end_text,path,sheets)
                    df=data_collection_central_federal_baroda(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df 
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        ...
                        if len(tables)>1:
                            df=data_collection_central_federal_baroda(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_central_federal_baroda('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)
        ...
        def data_collection_union(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_union(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df 
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        ...
                        if len(tables)>1:
                            df=data_collection_union(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_union('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)


        def data_collection_iob(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_central_federal(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'lattice',10,100,40)
                        if len(tables)>1:
                            df=data_collection_iob(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_iob('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)
        ...
        def data_collection_rbl(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_rbl(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'lattice',10,100,40)
                        if len(tables)>1:
                            df=data_collection_rbl(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_rbl('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

        def data_collection_indusind(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_indusind(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'stream',10,100,40)
                        if len(tables)>1:
                            df=data_collection_indusind(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_indusind('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

        def data_collection_idbi_city(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                    df.reset_index(drop=True,inplace=True)
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_idbi_city(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'stream',10,100,40)
                        if len(tables)>1:
                            df=data_collection_idbi_city(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_idbi_city('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)
        ...
        def data_collection_canara(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                    df.reset_index(drop=True,inplace=True)
                ...
                if loop <2:
                    ...
                    end_text='total'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_canara(df,heading,max_date,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df 
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'lattice',10,100,40)
                        if len(tables)>1:
                            df=data_collection_canara(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_canara('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

        def data_collection_uco(tables,search_str,max_date,bank_type,bank,date,type_read,loop):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if loop <2:
                    ...
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_uco(df,heading,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'lattice',10,100,40)
                        if len(tables)>1:
                            df=data_collection_uco(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_uco('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

        def data_collection_punjab(df,Consolidated=False):
            try:
                if type_read=='camelot':
                    df=get_desired_table(tables,search_str)
                else:
                ...
                if (Consolidated==True):
                    df=df[['Bank','Industry','Sub_Industry','Sl_No','Fund_Based_In_Million_Consolidated','Non_Fund_Based_In_Million_Consolidated','Relevant_Date','Runtime']]
                else:
                ...
                if loop <2:
                    ...
                    end_text='infrastructure'
                    df=search(heading,end_text,path,sheets)
                    df=data_collection_punjab(df,heading,bank_type,bank,date,'ilovepdf',2)
                else:
                    e='Somethig went wrong with both ilove pdf and camelot'
                    catch_error_df=get_error_df(table_name,bank,e,date,catch_error_df)
            return df
            ...
            for i in range(len(links_capital)):
                ...
                try:
                    try:
                        tables = extract_tables_from_pdf(link,False,'lattice',10,100,40)
                        if len(tables)>1:
                            df=data_collection_punjab(tables,search_str,max_date,bank_type,bank,date,'camelot',1)
                            print('returned df')
                            connection = engine.connect()
                            connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Industry_Wise_Distribution_Exposure_Status='Completed' where Links = '"+act_link+"'")
                        else:
                        ...
                        df=data_collection_punjab('',search_str,max_date,bank_type,bank,date,'ilovepdf',1)
                except Exception as e:
                    catch_error_df=get_error_df(bank_name,bank,e,date,catch_error_df)
                    print(e)

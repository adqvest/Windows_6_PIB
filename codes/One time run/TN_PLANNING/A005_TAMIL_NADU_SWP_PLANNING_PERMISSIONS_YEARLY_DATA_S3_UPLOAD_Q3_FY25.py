...
#%%     
        ...
        status_empty_data=pd.read_sql(f"select * from TAMIL_NADU_SWP_PLANNING_PERMISSIONS_YEARLY_DATA where S3_Upload_Status is null and S3_Upload_Comments is  null and  Relevant_Quarter in ('{req_quarter}') order by File_Id asc;", con=engine)

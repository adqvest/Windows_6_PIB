...
os.chdir(r'C:\Adqvest\Ministry of HRD\CAG STUFF DEC 2020')

headers = {"user-agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"}
driver=webdriver.Chrome(executable_path= r"C:\Adqvest\Selenium Extension\chromedriver.exe")
unable = pd.DataFrame()
data = pd.DataFrame()
overall_villages = pd.read_excel("CAG.xlsx")

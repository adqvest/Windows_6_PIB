...
#%%
        ...
        query1 = "Drop Table AdqvestDB.MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_NO_PIT"
        query2 = "Drop Table AdqvestDB.MEFCC_PROPOSALS_YEARLY_DATA_PARIVESH_NO_PIT_NF"
        try:

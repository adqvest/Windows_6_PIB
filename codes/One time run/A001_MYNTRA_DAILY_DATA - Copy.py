...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'MYNTRA_DAILY_PRODUCTS_DATA'
...
#                        data = get_json(soup)
                    ...
                    for l in range(len(data)):# in data:
                        ...
                        df.columns = ['Landing pageurl', 'Loyalty points enabled', 'Adid', 'Ispla', 'Product id',
                           ...
                           'Personalized coupon', 'Personalized coupon value', 'Product meta','Category','Sub_Category_1','Sub_Category_2','Category_Total_Pds']
                        ...
                        df = df[['Landing_Pageurl', 'Product', 'Productname', 'Rating', 'Ratingcount',
                           ...
                           'Is_Personalised','Rank','Category','Sub_Category_1','Sub_Category_2','Category_Total_Pds']]
                        ...
                        df.to_sql(name= 'MYNTRA_DAILY_PRODUCTS_DATA_2',con=engine,if_exists='append',index=False)

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'DOSEL_NAS_DIST_GEN_STU_PERF_PCT_CORRECT_YEARLY_ONE_TIME'
    ...
    try :
        ...
        def get_data(driver,hover_val,tag_val):
            for i in range(2):
                time.sleep(5)
                element_to_hover_over = driver.find_element("xpath", '/html/body/section/div[2]/main/div/div[2]/div[3]/div[3]/div/div/div['+str(tag_val)+']/div/div/div[5]/div/div[1]/div/div/div[1]/div[1]/div/div')
                time.sleep(4)
                ActionChains(driver).move_to_element_with_offset(element_to_hover_over, hover_val[0], 0).perform()
                time.sleep(2)
            for i in range(2):
                element_to_hover_over = driver.find_element("xpath", '/html/body/section/div[2]/main/div/div[2]/div[3]/div[3]/div/div/div['+str(tag_val)+']/div/div/div[5]/div/div[1]/div/div/div[2]/div[2]/div/div')
                time.sleep(4)
                ActionChains(driver).move_to_element_with_offset(element_to_hover_over, hover_val[1], 0).perform()
                time.sleep(4)
            for i in range(2): 
                element_to_hover_over = driver.find_element("xpath", '/html/body/section/div[2]/main/div/div[2]/div[3]/div[3]/div/div/div['+str(tag_val)+']/div/div/div[5]/div/div[1]/div/div/div[3]/div[1]/div/div')
                time.sleep(4)
        ...
        tag_val=[10,11]
        loop=1
        # list_buttons=list_buttons[11:12]
        for i in range(len(class_name)):
            ...
            for button in list_buttons:
                if button.has_attr('onclick'):
                    ...
                    count=0
                    for district in district_links[1:10]:
                        if district.has_attr('onclick'):
                            ...
                            print(df)
                            df.to_sql(name='DOSEL_NAS_DIST_GEN_STU_PERF_PCT_CORRECT_YEARLY_ONE_TIME',con=engine,if_exists='append',index=False)

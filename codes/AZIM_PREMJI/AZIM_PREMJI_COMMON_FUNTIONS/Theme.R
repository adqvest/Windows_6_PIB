...
LH_common_theme <- function() {
  theme(panel.border = element_blank(),
        ...
        # panel.grid.major = element_line(size = 0.2, linetype = 0, colour = "black"),
...
light_house_theme <- function(legend_dir='vertical',legend_position='right',val=1,
                              ...
                              leg_box_width=0.5,angle_x=0,v_just_x=0.5) {
  print('this is vallllll')
  print(val)
  print(leg_box_height)
  theme(axis.text.x = element_text(angle = angle_x, size = size-0.5, vjust = v_just_x, hjust = 0.5,
                                   margin = margin(r = 0.5)),  
        axis.title.y = element_text(angle = 90, vjust = 0.5, hjust = 0.5, size = size, margin = margin(r = 2),
                                     family = font),
        axis.text.y.left = element_text(size = size, margin = margin(r = 2),  family = font),  
        axis.text.y.right = element_text(size = size, margin = margin(r = 2),  family = font),  

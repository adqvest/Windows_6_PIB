...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        robot.add_link("https://www.hpxindia.com/MarketDepth/TAM/g-tam_details.html")
        ...
        while st_date < today.date():
            ...
            df = tables[0]
            # Changes | Pushkar | 3 Oct 2023 | 
            ## IF-ELSE to check if dataframe is empty and proceed
            if len(df) != 0:
                ...
                df.to_sql(name='HPX_GTAM_TRADE_DETAILS_DAILY_DATA',con=engine,if_exists='append',index=False)

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'HPX_TAM_TRADE_DETAILS_DAILY_DATA'
    ...
    try:
        ...
        max_rel_date=pd.read_sql('Select max(Relevant_Date) as Max from HPX_TAM_TRADE_DETAILS_DAILY_DATA',engine)['Max'][0]
        ...
        robot.add_link("https://www.hpxindia.com/MarketDepth/TAM/TradeDetails.html")
        ...
        if len(final_df) != 0:
            ...
            final_df.to_sql(name='HPX_TAM_TRADE_DETAILS_DAILY_DATA',con=engine,if_exists='append',index=False)
        else:
            print("No new data")

    ...
    try :
        ...
        if links_df.empty:
            ...
            for _,i in links_df.iterrows():
                ...
                #%%
                # link='C:/Users/Santonu/Desktop/ADQvest/Error files/today error/DGCA_DOMESTIC_MONTHLY_DATA2024_03_31.pdf'
                ...
                row_idx=row_col_index_locator(df,['month'])[1]
                col_idx=row_col_index_locator(df,['month'])[0]
                ...
                df=df.iloc[1:,:]
                df.reset_index(drop=True,inplace=True)
                df=df.rename(columns={'Month & Year':'Relevant_Date',"Month &":'Relevant_Date',"Year":'Relevant_Date',"Month":'Relevant_Date'})

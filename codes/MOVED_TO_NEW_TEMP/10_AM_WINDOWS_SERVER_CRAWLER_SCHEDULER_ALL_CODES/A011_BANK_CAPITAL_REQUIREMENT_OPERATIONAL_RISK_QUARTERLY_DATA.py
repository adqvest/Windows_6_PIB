...
def update_basel_iii(bank,date):
    ...
    connection.execute("update BANK_BASEL_III_QUARTERLY_LINKS set Bank_Capital_Requirement_Operational_Risk_Status = 'COMPLETED' where Relevant_Date = '"+str(date)+"' and Bank= '"+bank+"'")

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    table_name = 'INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS,INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS_CHUNKED'
    ...
    try:
        ...
        doc_ids = client.execute('''SELECT distinct Document_Id FROM INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS_CHUNKED;''')
        ...
        for obj in response:
            ...
            try:
                try:
                    ...
                    connection.execute("update INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS set Chunking_Status='ISSUE' where File_Name = '" +str(file_name).replace('.pdf', '')+"'")
        ...
        if len(doc)>1:
            ...
            for batch_num in range(total_batches):
                ...
                query = f"""
                    ALTER TABLE INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS_CHUNKED
                    UPDATE 
        ...
        doc = client.execute('''SELECT distinct Document_Id as id FROM INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS_CHUNKED where Runtime_Scraped is Null ;''')
        print(len(doc))
        ...
        doc = client.execute('''SELECT distinct Document_Id as id FROM INDIA_BUDGET_ECONOMIC_SURVEY_YEARLY_DATA_CORPUS_CHUNKED where Published_Date is Null ;''')
        print(len(doc))

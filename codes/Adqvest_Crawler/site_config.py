...
class SiteConfig:
    ...
    locality_options_selector: Optional[str] = None
    ...
    regular_fall_back: bool = None
    page_load: bool = None
    clear_input_field: bool = None
    skip_custom_extractor:bool = None
    ...
    links_selector_lyr2: Optional[str] = None
    links_selector_lyr3: Optional[str] = None
    ...
    all_view_option_selector: Optional[str] = None
    additional_view_option_selector: Optional[str] = None
    ...
    radius_selector: Optional[List[str]] = None
    ...
    max_retry_per_page: Optional[int] = 4
    page_refresh_interaval: Optional[int] = 90
    
    cookie_reject_selector: Optional[str] = None
    popup_close_selectors: Optional[List[str]] = None
    selection_strategy: Optional[List[str]] = None
...
class SiteConfigLoader:
    ...
    def _load_configs(self,info_type:str='sites'):
        """Load standard JSON (removes comment fields)"""
        try:
            with open(self.config_file, 'r', encoding='utf-8') as f:
                data = json.load(f)
            # print(data)
            sites=data.get(info_type, [])
            configs={}
            if info_type=='sites':
                for site in sites:
                    ...
                    # print(configs)
                print(f"Providing Configs::{type(configs)}")
                return configs
    ...
    def _create_config_from_json(self,site_data:Dict[str, any]) -> SiteConfig:
        ...
        try:
            ...
            config = SiteConfig(
                ...
                locality_options_selector=site_data.get("selectors",{}).get('locality_options_selector',None),
                ...
                radius_selector=site_data.get("selectors",{}).get('radius_selector', None),
                ...
                links_selector_lyr2=site_data.get("selectors",{}).get('links_selector_lyr2', None),
                links_selector_lyr3=site_data.get("selectors",{}).get('links_selector_lyr3', None),
                ...
                all_view_option_selector=site_data.get("selectors",{}).get('all_view_option_selector', None),
                additional_view_option_selector=site_data.get("selectors",{}).get('additional_view_option_selector', None),
                popup_close_selectors=site_data.get("selectors",{}).get('popup_close_selectors', None),
                ...
                skip_custom_extractor=site_data.get("options",{}).get('skip_custom_extractor', False),
                ...
                regular_fall_back=site_data.get("options",{}).get('regular_fall_back', True),
                page_load=site_data.get("options",{}).get('regular_fall_back', False),
                ...
                category=site_data.get("options",{}).get('category', None),
                Sub_Category_1=site_data.get("options",{}).get('Sub_Category_1', None),
                Sub_Category_2=site_data.get("options",{}).get('Sub_Category_2', None),
                selection_strategy=site_data.get("options",{}).get('selection_strategy', None),
                clear_input_field=site_data.get("options",{}).get('clear_input_field', None),

                max_retry_per_page=site_data.get("options",{}).get('max_retry_per_page', 5),
                page_refresh_interaval=site_data.get("options",{}).get('page_refresh_interaval', 60),
                #---------------------------------------------------------------------------------------------------
                request_timeout=site_data.get("request_selectors",{}).get('request_timeout', None),
                request_url=site_data.get("request_selectors",{}).get('request_url', None),
                request_params=site_data.get("request_selectors",{}).get('request_params', None),
                request_json=site_data.get("request_selectors",{}).get('request_json', None),
                request_data=site_data.get("request_selectors",{}).get('request_data', None),
                request_cookies=site_data.get("request_selectors",{}).get('request_cookies', None),
                request_headers=site_data.get("request_selectors",{}).get('request_headers', None),

...
all_sites=SiteConfigLoader()._load_configs(info_type="site_groups")["InputBasedStrategy_Long"]
# not_req=SiteConfigLoader()._load_configs(info_type="site_groups")["AMBIT"]

# all_sites=list(set(all_sites)-set(not_req))
# print(f'TOTAL SITES::{len(all_sites)}\n{all_sites}')
# print(all_sites)
# all_sites=["harley_davidson","baja_auto"]

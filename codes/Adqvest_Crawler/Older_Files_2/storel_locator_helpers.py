...
class BrowserManager:
    ...
    def create_crawler(self, request_handler):
        try:
            ...
            self.crawler = PlaywrightCrawler(request_handler=request_handler,headless=False,max_requests_per_crawl=20,
                                             browser_type='chromium',request_handler_timeout=timedelta(minutes=300),

...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        def get_dates(cond):
            ...
            min_date=datetime.date(2024,8,31)
            ...
            if(cond):
                dates_df = dates_df[:2] #change it back to 4
        ...
        if(( vahan_maker_state_done.shape[0]>0 ) | (table_check())):
            ...
            if (today.day in [2,3] or (today.date()-max_date).days>=31):   #change it to 2 after this data collection
                print('B')

...
from search_data_provider import InputDataSource as Table_Info
...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try :
        ...
        # to = 'ammar.tyabji@thurro.com, pooja.ganesan@thurro.com'
        to = 'pooja.ganesan@thurro.com'
        ...
        df_wkly_not_coll=asyncio.run(Table_Info.get_data_info(not_collecting=True))
        ...
        #%%
        body3 = f"\n\nHere is the Stores Not Collecting more than a week as of {yesterday.date()}."
        body_parts.append({'type': 'plain', 'content': body3})

        df_wkly_not_coll.reset_index(drop=True, inplace=True)
        body_parts.append(
            {'type': 'html', 'content': df_wkly_not_coll.to_html()})

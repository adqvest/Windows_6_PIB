...
def run_program(run_by = 'Adqvest_Bot', py_file_name = None):
    ...
    try :
        ...
        query = "SELECT * FROM BSE_ANNOUNCEMENT_ANNUAL_REPORT_COMPANY_WISE_YEARLY_DATA where S3_Upload_Status = 'Failed';"
        ...
        for index, row in raw_df.iterrows():
            ...
            filepath = os.path.join(r'C:\\Users\\Administrator\\AdQvestDir\\Junk_One_Time_1', filename)
            key1 = 'BSE_ANNUAL_REPORTS_CORPUS_TO_BE_CHUNKED/' + filename
            print(key1)
            key2 = 'BSE_ANNUAL_REPORTS_CORPUS/' + filename
            print(key2)

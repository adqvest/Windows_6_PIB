...
def run_program(run_by='Adqvest_Bot', py_file_name=None):    
    ...
    try:
        ...
        S3_PREFIX = "ICRA/"  
        S3_PREFIX_NEW1 = "ICRA_CORPUS/" 
        S3_PREFIX_NEW2 = "ICRA_CORPUS_TO_BE_CHUNKED/"
        ...
        query = "SELECT * FROM ICRA_DAILY_DATA_CORPUS_NEW WHERE S3_Upload_Comments IS NULL OR S3_Upload_Comments != 'Rename Done';"
        ...
        for index, row in raw_df.iterrows():
            ...
            try:
                ...
                query = text("UPDATE ICRA_DAILY_DATA_CORPUS_NEW SET S3_Upload_Comments= 'Rename Done' WHERE File_Name = :old")
                ...
                connection = engine.connect()
                query = text("UPDATE ICRA_DAILY_DATA_CORPUS_NEW SET S3_Upload_Comments = 'Rename Failed' WHERE File_Name = :old")
                connection.execute(query, {"old": old_file_name}) 
                print(query)     

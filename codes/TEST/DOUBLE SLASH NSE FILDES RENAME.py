...
for key in all_keys:
    if key.startswith('NSE_INVESTOR_INFORMATION_CORPUS_2//'):
        double_slash_keys.append(key)
    elif key.startswith('NSE_INVESTOR_INFORMATION_CORPUS_2/') and not key.startswith('NSE_INVESTOR_INFORMATION_CORPUS_2//'):
...
count = 0
for old_key in double_slash_keys:
    ...
    if match:
        ...
        new_key = f"NSE_INVESTOR_INFORMATION_CORPUS_2//{new_filename}"  # Keep double slash

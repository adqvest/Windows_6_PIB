...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        def get_dates(cond):
            ...
            query = "select distinct Relevant_Date FROM VAHAN_MAKER_VS_CATEGORY_VS_FUEL_RTO_LEVEL_MONTHLY_DATA where Relevant_Date in('2023-04-30')"
            ...
            # query = "select distinct Relevant_Date FROM VAHAN_MAKER_VS_CATEGORY_VS_RTO_LEVEL_DATA_CLEAN_FINAL where Relevant_Date>='2016-01-01' and Relevant_Date <='2016-12-31'"
            # maker_vs_fuel_db_data = pd.read_sql(query, engine)
            #

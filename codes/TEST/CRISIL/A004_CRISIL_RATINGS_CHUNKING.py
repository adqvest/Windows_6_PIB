...
def run_program(run_by='Adqvest_Bot', py_file_name=None):    
    ...
    try:
        ...
        # query = "SELECT * FROM CRISIL_DAILY_DATA_CORPUS_NEW where File_ID > 80000 AND File_ID < 100000 AND Chunking_Status is Null;"
        crisil_ratings = pd.read_sql(query,con=engine)
        crisil_ratings = crisil_ratings[25000:33000].reset_index(drop=True)

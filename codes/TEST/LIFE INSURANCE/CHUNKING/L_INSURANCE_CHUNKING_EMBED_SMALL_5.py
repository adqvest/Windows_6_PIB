...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        folder_name = 'LIFE_INSURANCE_CORPUS_7'
        ...
        response = [ x for x in response if 'LIFE_INSURANCE_CORPUS_7/' in x]
        
        response = response[25441:]
        print(len(response))
        
        doc_ids = client.execute(f'''SELECT distinct document_id FROM thurro_pdf_documents_vector_db_life_insurance_final_v2;''')

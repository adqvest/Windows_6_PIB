...
def run_program(run_by='Adqvest_Bot', py_file_name=None):
    ...
    try:
        ...
        key1='GENERAL_INSURANCE_FY26_CORPUS/'
        key2='GENERAL_INSURANCE_FY26_CORPUS_TO_BE_CHUNKED/'
        path=r'C:/Users/Administrator/AdQvestDir/GENERAL_INSURANCE_Q1_FY26/'

        df_links=pd.read_sql("select * from GEN_INSURANCE_QUARTERLY_DATA_CORPUS where Relevant_Date='2025-01-31'",engine)
        # df_links=df_links[1500:3000]
        ...
        for i, row in df_links.iterrows():
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if 'application/pdf' or 'text' in content_type:
